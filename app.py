...
#feature the labels data with labelEncoder
...
cv = CountVectorizer(stop_words="english",ngram_range=(1,1),analyzer='word',max_df=1.0, min_df=1, max_features=None,lowercase=True)
